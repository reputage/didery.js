...
import {concatenateUint8Arrays,
    ...
    fromBase64,
    keyInceptionEvent,
    keyRotationEvent} from '../src/index';
...
it('Test parseSignatureHeader', function() {
    ...
    signature = "testing";
    expected = new Error("Signature formatted incorrectly");
...
it('Test generateKeyPair', async function() {
    ...
    expected = [new Uint8Array([70,81,79,121,66,71,103,69,120,52,89,112,52,102,78,51,54,68,117,70,109,106,87,49,107,55,113,75,79,86,111,
        101,167,185,202,28,236,26,127,61,230,20,129,200,113,50,88,24,161,11,216,134,159,167,151,183,94,25,189,11,128,
        151,39,237]), new Uint8Array([167,185,202,28,236,26,127,61,230,20,129,200,113,50,88,24,161,11,216,134,159,167,
...
it('Test fromBase64', async function () {
    ...
    expected = new Uint8Array([98,108,127,209,24,183,46,123,174,159,230,239,27,247,0,223,107,244,26,141,202,49,22,123,245,228,
        62,1,68,10,226,107]);
    padding = 1;
    assert.deepEqual(await fromBase64(key, padding), expected);
});
...
it('Test keyInceptionEvent', async function () {
    ...
    let expected = [new Uint8Array([70,81,79,121,66,71,103,69,120,52,89,112,52,102,78,51,54,68,117,70,109,106,87,49,107,55,113,75,79,86,111,
        101,167,185,202,28,236,26,127,61,230,20,129,200,113,50,88,24,161,11,216,134,159,167,151,183,94,25,189,11,128,
        151,39,237]), new Uint8Array([167,185,202,28,236,26,127,61,230,20,129,200,113,50,88,24,161,11,216,134,159,167,
        151,183,94,25,189,11,128,151,39,237])];
    ...
    options = {};
    options.preRotatedKeyPair = [new Uint8Array([70,81,79,121,66,71,103,69,120,52,89,112,52,102,78,51,54,68,117,70,109,106,
        87,49,107,55,113,75,79,86,111,101,167,185,202,28,236,26,127,61,230,20,129,200,113,50,88,24,161,11,216,134,159,
        167,151,183,94,25,189,11,128,151,39,237]), new Uint8Array([])];
    ...
    options = {};
    options.preRotatedKeyPair = [new Uint8Array([]), new Uint8Array([167,185,202,28,236,26,127,61,230,20,129,200,113,50,88,
        24,161,11,216,134,159,167,151,183,94,25,189,11,128,151,39,237])];
    ...
    // TODO: Expand assertions to include browser and server functionality.
});
...
it('Test keyRotationEvent', async function () {
    ...
    // TODO: Add assertions when browser and server functionality is available.
});
