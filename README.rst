...
for each function can be found in the `docs <https://github.com/reputage/didery.js/tree/master/docs/git-index.rst>`_ folder
of the project. The examples included in the examples folder must have their JavaScript compiled before being viewed. 
